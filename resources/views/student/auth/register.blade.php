            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('student.register') }}">
                        ...
                        <div class="form-group row">
                            <label for="birthday" class="col-md-4 col-form-label text-md-left">{{ __('Birthday') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="state" class="col-md-4 col-form-label text-md-left">{{ __('State') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="qualification" class="col-md-4 col-form-label text-md-left">{{ __('Qualification') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="job" class="col-md-4 col-form-label text-md-left">{{ __('Job') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="church" class="col-md-4 col-form-label text-md-left">{{ __('church') }}</label>

                            <div class="col-md-6">
                                <input id="church" type="text" class="form-control @error('church') is-invalid @enderror" name="church" value="{{ old('church') }}" required autocomplete="church">
