      ...
      <span class="brand-text font-weight-light">پنل مدیریت</span>
        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                ...
                <li class="nav-item has-treeview {{ Route::is('admin.students.index') || Route::is('admin.students.create') ? 'menu-open' : '' }}">
                    <a href="#" class="nav-link {{ Route::is('admin.students.index') || Route::is('admin.students.create') ? 'active' : '' }}">
                ...
                <li class="nav-item has-treeview {{ Route::is('admin.exams.index') || Route::is('admin.exams.create') ? 'menu-open' : '' }}">
                    <a href="#" class="nav-link {{ Route::is('admin.exams.index') || Route::is('admin.exams.create') ? 'active' : '' }}">
                    <i class="nav-icon fa fa-users"></i>
                    <p>
                        الامتحانات
                        <i class="right fa fa-angle-left"></i>
                    ...
                    <ul class="nav nav-treeview">
                    <li class="nav-item">
                        <a href="{{ route('admin.exams.index') }}" class="nav-link {{ Route::is('admin.exams.index') ? 'active' : '' }}">
                        <i class="fa fa-circle-o nav-icon"></i>
                        <p>قائمه الامتحانات</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('admin.exams.create') }}" class="nav-link  {{ Route::is('admin.exams.create') ? 'active' : '' }}">
                        <i class="fa fa-circle-o nav-icon"></i>
                        <p>اضافة امتحان</p>
                        </a>
                    </li>
