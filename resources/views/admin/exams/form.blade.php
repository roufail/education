        ...
        <div class="card-body">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-3">
                    ...
                    <input type="text" name="doctor" value="{{ old_value($exam,"doctor") }}"
                        class="form-control @error(" doctor") is-invalid @enderror" id="doctor"
                ...
                <div class="form-group col-md-3">
                    ...
                    <input type="text" name="started_at" value="{{ old_value($exam,"started_at") }}"
                        class="form-control @error(" started_at") is-invalid @enderror" id="started_at"
                        placeholder="ادخل تاريخ الامتحان">
                    @error("started_at")
                    <small class="text-danger">{{ $message }}</small>
                    @enderror
                </div>
                ...
                <div class="form-group col-md-3">
                    ...
                    <input type="text" name="ended_at" value="{{ old_value($exam,"ended_at") }}"
                        class="form-control @error(" ended_at") is-invalid @enderror" id="ended_at"
                        placeholder="ادخل ناريخ نهايه الامتحان">
                    @error("ended_at")
                    <small class="text-danger">{{ $message }}</small>
                    @enderror
                </div>
                ...
                <div class="form-check mt-4 mr-3">
                    <input type="checkbox" name="on" value="1" @if(old_value($exam,"on")==1) checked @endif
